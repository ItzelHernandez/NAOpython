...
def mainRoutine():
    ...
    tts.say("Ahora empecemos... muestrame una lata?")
    sleep(1) #el niño busca la carta del perro, que es roja
    repeatRed=1

    while repeatRed > 0: #valida color rojo
      photoCP.takePictures(5,'/home/nao/pythonProjects', 'nao')
      ...
      if l0 != 0 or l1 != 0 or l2 != 0:
        ...
        if colorDetected == l0:
          tts.say("Muy bien, si es una lata!")
          print("Red detected")
          repeatRed=0
    ...
    tts.say("Ahora.. ¿podrias mostrarme un carton?") #valida color cafe
    sleep(1) 
    repeatBrown=1
    ...
    tts.say("Ahora.. ¿podrias mostrarme un carton?")
    sleep(1) 
    repeatWhite=1
    ...
    while repeatWhite > 0:
          ...
          if l0 != 0 or l1 != 0 or l2 != 0:
            ...
            if colorDetected == l2:
              tts.say("Muy bien, si es plastico!")
              repeatWhite=0
